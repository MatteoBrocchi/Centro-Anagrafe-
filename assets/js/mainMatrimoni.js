$(function() {
    ...
    function StampaTabella(indicePartenza, numShow, array) { //DA FIXXARE PER MATRIMONI
        ...
        for (let i = ((indicePartenza * numShow) - numShow); i < arrivo; i++) {
            ...
            else $("#persone").append("<tr><td style='text-decoration: line-through'>" + array[i].nome + "</td><td style='text-decoration: line-through'>" + array[i].cognome + "</td><td style='text-decoration: line-through'>" + array[i].matrimoni[0].nome_coniuge + "</td><td style='text-decoration: line-through'>" + array[i].matrimoni[0].cognome_coniuge + "</td><td style='text-decoration: line-through'>" + arrayData + "</td><td style='text-decoration: line-through'>" + array[i].matrimoni[0].comune + "</td><td class=\"d-flex justify-content-center bottoni\"><i class=\"fas fa-trash-alt delete rounded\" title=\"Elimina\" id=\"" + array[i].id + "\" data-toggle=\"modal\" data-target=\"#modalEliminaRes\"></i><i class=\"fas fa-edit edit rounded\" title=\"Modifica\" id=\"" + array[i].id + "\" data-toggle=\"modal\" data-target=\"#exampleModalEdit\"></i><a href=\"indexMatrimonioPersona.html\"><i class=\"fas fa-church wedding rounded\" title=\"Add Matrimonio\" id=\"" + array[i].id + "\"></i></a></td></tr>"); 
        }
    }
