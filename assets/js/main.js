                    ...
                    dataType: "json",
                        ...
                        $(document).on("click", ".inviaModifica", function() {
                                ...
                                $.ajax({
                                        ...
                                        }); dt = '{"nome":"' + $("#nomemod").val().toString() + '","cognome":"' + $('#cognomemod').val().toString() + '","anno_nascita":"' + $('#annomod').val().toString() + '","anno_residenza":"2020"}'; $.ajax({
                                        type: "POST",
                                        headers: { "Access-Control-Allow-Origin": "*" },
                                        data: dt,
                                        /* Per poter aggiungere una entry bisogna prima autenticarsi. */
                                        ...
                                        dataType: "json",
                                        success: function(data) {},
                                    }); $('#exampleModalEdit').modal('toggle'); document.getElementById("loading_screen").style.display = 'block'; AggiornaTabella(); persone = []; $.ajax({
                                        type: "GET",
                                        contentType: "application/json",
                                        url: "https://late-frost-5190.getsandbox.com/anagrafiche",
                                        dataType: "json",
